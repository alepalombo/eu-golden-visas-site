...
export const metadata: Metadata = {
  ...
  description:
    'The five EU residency-by-investment programs left standing in 2026. What they actually cost, who they actually fit, and which one fits you. 90-minute live webinar with Q&A. Free registration.',
  openGraph: {
    title: 'Top European Golden Visas, Compared — Free Live Webinar',
    description:
  ...
  twitter: {
    ...
    title: 'Top European Golden Visas, Compared — Free Live Webinar',
    description:
      'Italy · Greece · Portugal · Hungary · Malta · Cyprus. The five EU programs left, side by side. 90-min live session with Q&A. Free.',
  },
