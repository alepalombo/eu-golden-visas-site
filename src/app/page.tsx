...
const AGENDA_SECTIONS = [
  ...
  },
  {
    ...
    duration: '15 min',
    desc: 'The fees the placement industry doesn’t publish. Guarantees you should refuse. The five rules nobody tells you before buying EU optionality. Then full live Q&A on your specific situation.',
  },
];
  ...
  return (
    <div className="pt-14">
        ...
        <div className="relative z-10 mx-auto flex min-h-[90vh] max-w-[1100px] items-center justify-center px-6 pt-24 pb-32">
          <div className="w-full max-w-[760px] text-center text-white">
            ...
            <p className="mx-auto mb-5 max-w-xl text-lg font-medium leading-relaxed text-white md:text-xl [text-shadow:0_1px_10px_rgba(0,0,0,0.4)]">
              The five EU residency-by-investment programs left standing in 2026, plus Cyprus PR. <span className="font-bold">2 hours covering everything</span> about Italy, Greece, Portugal, Hungary, Malta and Cyprus &mdash; honestly compared.
            </p>

            <p className="mx-auto mb-10 max-w-md text-sm font-medium text-white/80">
              Wednesday, June 10th at 5:00 PM Lisbon time (6:00 PM Rome). Live on Zoom with Q&A.
            </p>
          ...
          <div className="flex flex-col gap-10 md:flex-row md:gap-14">
            ...
            <div className="flex-1 space-y-4 text-sm leading-relaxed text-muted md:text-[15px]">
              <p>
                ...
                Ph.D. in Public Law, qualified Italian lawyer, master in regulation of global markets. A decade building businesses, residencies and investment structures across European and non-European jurisdictions. &euro;25M+ moved through these programs from the inside &mdash; not from a placement deck.
              </p>
              <p>
                Real-estate development companies operating from 2016&ndash;2017 to today. Hundreds of apartments delivered. The person behind some of the most-followed jurisdictional intelligence content on the internet.
              </p>
              <p>
      ...
      <section className="mx-auto max-w-[800px] px-6 py-24 md:py-28">
        ...
        <h2 className="mb-4 font-serif text-2xl font-light tracking-tight md:text-3xl">
          2 hours, 7 sections, <span className="italic">full Q&A.</span>
        </h2>
      ...
      <section className="mx-auto max-w-[800px] px-6 py-24 md:py-28">
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          {[
            { label: 'Format', value: 'Live on Zoom, 2 hours including Q&A' },
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-[700px] px-6 py-24 text-center text-white md:py-32">
          ...
          <h2 className="mb-4 font-serif text-2xl font-light tracking-tight md:text-3xl">
            Two hours that will save you <span className="italic">weeks of research.</span>
          </h2>
          <p className="mx-auto mb-10 max-w-md text-sm leading-relaxed text-white/50">
            Most people considering an EU Golden Visa spend months piecing together fragmented information from placement decks, blog posts, and outdated guides. Two hours with one practitioner who runs jurisdictional intelligence as a full-time discipline is the fastest way to see the full landscape honestly &mdash; and know which program, if any, fits you.
            <br /><br />
